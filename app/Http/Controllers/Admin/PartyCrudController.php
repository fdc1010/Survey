...
use App\Http\Requests\PartyRequest as StoreRequest;
use App\Http\Requests\PartyRequest as UpdateRequest;
...
class PartyCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Party');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/party');
        $this->crud->setEntityNameStrings('party', 'parties');
        ...
        */
        ...
        // add asterisk for fields that are required in PartyRequest
