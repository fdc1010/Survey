...
use App\Http\Requests\MunicipalityRequest as StoreRequest;
use App\Http\Requests\MunicipalityRequest as UpdateRequest;
...
class MunicipalityCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Municipality');
        ...
        */
        ...
        // add asterisk for fields that are required in MunicipalityRequest
