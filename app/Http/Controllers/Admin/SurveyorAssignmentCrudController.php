...
class SurveyorAssignmentCrudController extends CrudController
{
	...
	public function showDetailsRow($id){
		$areas = AssignmentDetail::where('assignment_id',$id)
										->with('sitio')
										->get();
		$result = "<h4>Assigned Areas:</h4><div class='col-lg-12'>";
		foreach($areas as $area){
			$result .= "<div class='col-lg-2'>".$area->sitio->name.
						"</div><div class='col-lg-2'>quota: ".$area->quota.
						"</div><div class='col-lg-2'>count: ".$area->getSurveyCount().
						"</div><div class='col-lg-6'>progress: ".$area->getProgressBar().
						"</div>";
		}
		$result .= "</div>";
		return $result;
