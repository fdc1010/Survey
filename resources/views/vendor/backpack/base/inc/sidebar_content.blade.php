...
<li class="treeview">
  ...
  <ul class="treeview-menu">
    ...
    <li><a href='{{ backpack_url('barangaysurveyable') }}'><i class='fa fa-map'></i> <span>Survey Per User</span></a></li>
    <li><a href='{{ backpack_url('surveycandidate') }}'><i class='fa fa-user'></i> <span>Survey Per Candidate</span></a></li>
