...
<li class="treeview">
  ...
  <ul class="treeview-menu">
    ...
    <li><a href='{{ backpack_url('barangaysurveyable') }}'><i class='fa fa-user'></i> <span>Barangay Survey</span></a></li>
    <li><a href='{{ backpack_url('surveycandidate') }}'><i class='fa fa-edit'></i> <span>Survey Candidate/Position</span></a></li>
