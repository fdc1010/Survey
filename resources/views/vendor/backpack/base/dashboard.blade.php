    ...
    <div class="row">
    	...
    	<div class="col-md-6" style="font-size:24px; font-weight:bolder;">
            <div class="box box-default">
                ...
                <div class="box-body">
                      <div id="tblvotes" class="mCustomScrollbar custom-css" data-mcs-theme="dark" style="height:480px;">
        ...
        <div class="col-md-6" style="font-size:24px; font-weight:bolder;">
            <div class="box box-default">
                ...
                <div class="box-body">
                      <div id="tblgender" class="mCustomScrollbar custom-css" data-mcs-theme="dark" style="height:480px;">
                      		<table class="table table-striped_dashboard table-hover display responsive nowrap" cellspacing="0">
            					           <thead>
                                    <tr>
                                        <th>Cadidates</th>
        ...
        @endif
         ...
         @foreach($surveydetails as $surveydetail)
            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                      <div id="tblcivilstatus" class="mCustomScrollbar custom-css" data-mcs-theme="dark" style="height:480px;">
                      		<table class="table table-striped_dashboard table-hover display responsive nowrap" cellspacing="0">
                              <thead>
                                  <tr>
                                    <th>Candidates</th>
        ...
        <div class="col-md-6" style="font-size:24px; font-weight:bolder;">
            <div class="box box-default">
                ...
                <div class="box-body">
                      <div id="tblempstatus" class="mCustomScrollbar custom-css" data-mcs-theme="dark" style="height:480px;">
                      		<table class="table table-striped_dashboard table-hover display responsive nowrap" cellspacing="0">
                            <thead>
                              <th>Candidates</th>
    	...
    	<div class="col-md-12" style="font-size:24px; font-weight:bolder;">
            <div class="box box-default">
                ...
                <div class="box-body">
                      <div id="tblagebracket" class="mCustomScrollbar custom-css" data-mcs-theme="dark" style="height:480px;">
                      		<table class="table table-striped_dashboard table-hover display responsive nowrap" cellspacing="0">
                            <thead>
                              <tr>
                                  <th>Candidates</th>
          ...
          @foreach($surveydetails as $surveydetail)
           <div class="col-md-12" style="font-size:24px; font-weight:bolder;">
               <div class="box box-default">
                   ...
                   <div class="box-body">
                         <div id="tblproblem" class="mCustomScrollbar custom-css" data-mcs-theme="dark" style="height:480px;">
                               <table class="table table-striped_dashboard table-hover display responsive nowrap" cellspacing="0">
                                  <thead>
                                     <tr>
                                      <th>Candidates</th>
       ...
       <div class="col-md-12" style="font-size:24px; font-weight:bolder;">
           <div class="box box-default">
               <div class="box-header with-border">
                   ...
                   <div class="box-body">
                         <div id="tblqualities" class="mCustomScrollbar custom-css" data-mcs-theme="dark" style="height:480px;">
                           <table class="table table-striped_dashboard table-hover display responsive nowrap" cellspacing="0">
                                <thead>
                                    </tr>
                                      <th>Candidates</th>
