...
<div @include('crud::inc.field_wrapper_attributes') >
    ...
    <select
        ...
        @if (isset($field['model']))
            @foreach ($field['model']::whereHas($field['entity2'],function($q){$q->doesntHave($field['entity3'])->doesntHave($field['entity4']);})->where($field['compare_field'],$field['compare_value'])->get() as $connected_entity_entry)
