...
<div @include('crud::inc.field_wrapper_attributes') >
    ...
    <select
        ...
        @if (isset($field['model']))
            @foreach ($field['model']::whereHas('positions',function($q){$q->doesntHave('positions')->doesntHave('options');})->where($field['compare_field'],$field['compare_value'])->get() as $connected_entity_entry)
